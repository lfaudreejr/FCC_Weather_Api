    ...
    function success(position)
    {
      ...
      .then(
        function(forecast)
        {
          ...
          next.innerHTML = "Tomorrow: " + forecast.forecast.forecastday[1].day.maxtemp_f + " &deg;F";
          next_icon.setAttribute("src", "https://" + forecast.forecast.forecastday[1].day.condition.icon);
          second_day.innerHTML = "Day After: " + forecast.forecast.forecastday[2].day.maxtemp_f + " &deg;F";
          second_icon.setAttribute("src", "https://" + forecast.forecast.forecastday[2].day.condition.icon);
          third_day.innerHTML = "Third day: " + forecast.forecast.forecastday[3].day.maxtemp_f + " &deg;F";
